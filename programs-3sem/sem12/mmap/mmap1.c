...
int main() {
  ...
  /* Вычисляем будущую длину файла
     ...
     мы собираемся записать в него 100 раз слово "Text" */
  char content[] = "Text";
  size_t length = MAX_NUMBER * (strlen(content)) * sizeof(char) + 1;
  ...
  /* В цикле заполняем образ файла словом "Text" 100 раз.
